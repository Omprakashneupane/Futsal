...
<body>
    ...
    <div class="container" width='50%'>
        <form action="/admin/futsal" method="POST" enctype='multipart/form-data'>
            ...
            <div align='left'>
                <h5>Name</h5>
                <input type="text" name="futsal_name" style="width: 500px;height: auto;"><br>
                <h5>Owner Name</h5>
                <input type="text" name="owner_name" style="width: 500px;height: auto;">
                <h5>Contact</h5>
                <input type="text" name="contact" style="width: 500px;height: auto;">
                <h5>Email</h5>
                <input type="email" name="email" style="width: 500px;height: auto;">
                <h5>Price</h5>
                <input type="number" name="price" style="width: 500px;height: auto;">
                <div align='center' style="display: flex;justify-content: left;width: 60%;margin: 10px;">
                    ...
                    <div style="margin-left: 200px;">
                        ...
                        <select name="area">
                            ...
                            <option value="Gokarana">Gokarna</option>
